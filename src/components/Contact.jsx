...
const Contact = () => {
    ...
    const contactInfo = [
        ...
        },
        {
            ...
            label: 'LinkedIn',
            value: 'linkedin.com/in/mrigyanshi',
            href: 'https://www.linkedin.com/in/mrigyanshi/',
        },
        {
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            label: 'GitHub',
            value: 'github.com/mrigyanshii',
            href: 'https://github.com/mrigyanshii',
        },
    ];
                ...
                <div className="contact__grid">
                    ...
                    <div className="contact__info">
                        ...
                        <p className="contact__info-text">
                            Feel free to reach out for collaborations, opportunities, or just a friendly chat about technology and AI/ML!
                        </p>
