...
const Skills = () => {
    const skillCategories = [
        ...
        },
        {
            ...
            skills: ['HTML/CSS', 'Bootstrap', 'NodeJS', 'ReactJS', 'Tailwind CSS'],
            color: 'black',
        },
        {
            ...
            skills: ['MySQL', 'MongoDB', 'Git & GitHub', 'Jupyter Notebook', 'Figma', 'Docker'],
            color: 'blue',
        },
        {
            title: 'Soft Skills',
            ...
            skills: ['Problem Solving', 'Team Player', 'Adaptability', 'Creative Thinking', 'Time Management'],
            color: 'black',
        },
    ];
